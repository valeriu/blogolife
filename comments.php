...
<?php	printf( _n( 'One Response', '%1$s Responses', get_comments_number(), 'wplook' ),	number_format_i18n( get_comments_number() ), '<em>' . get_the_title() . '</em>' );	?>
</h2><div class="left-corner"></div></header>
...
<?php else : // or, if we don't have comments:
	if ( ! comments_open() ) :
?>
<p class="nocomments"><?php _e( 'Comments are closed.', 'wplook' ); ?></p>
