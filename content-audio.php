...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="col2 fright">		
		<header class="entry-header">
			<h1 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'wplook' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a>
			</h1>
		</header>
		...
		<?php elseif ( is_single() ): ?>	
			...
			<!-- .entry-content -->
				...
				<div class="entry-utility">
					...
					<div class="tag"> 
						<b><?php _e('Tag:', 'wplook'); ?></b> <?php echo get_the_tag_list('',', ',''); ?><div class="end"></div></div>
					<?php } ?>
				</div>
				<!-- .entry-utility -->		
				<div class="clear"></div>
